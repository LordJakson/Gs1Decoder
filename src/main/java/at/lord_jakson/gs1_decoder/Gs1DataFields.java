...
public class Gs1DataFields
{
    ...
    public static class Field_Item implements Gs1DataField_Type
    {
        ...
        public final boolean varDec;

        public Field_Item(String applicationIdentifier, String title, String regEx, int dataLen, boolean varLen, boolean varDec)
        {
    ...
    private static Field_ListRoot initGs1Data()
    {
        ...
        root.addItem("15", "15", "BEST_BEFORE", "^15(\\d{6})$", 6, false, false);
        ...
        Field_List group31 = root.addList("31");
        group31.addItem("0", "310", "WEIGHT_NET_KG", "^310([0-5])(\\d{6})$", 6, false, true);
        group31.addItem("1", "311", "LENGTH_M", "^311([0-5])(\\d{6})$", 6, false, true);
        group31.addItem("2", "312", "WIDTH_M", "^312([0-5])(\\d{6})$", 6, false, true);
        group31.addItem("3", "313", "HEIGHT_M", "^313([0-5])(\\d{6})$", 6, false, true);
        group31.addItem("4", "314", "AREA_M", "^314([0-5])(\\d{6})$", 6, false, true);
        group31.addItem("5", "315", "VOLUME_NET_L", "^315([0-5])(\\d{6})$", 6, false, true);
        group31.addItem("6", "316", "VOLUME_NET_M3", "^316([0-5])(\\d{6})$", 6, false, true);

        Field_List group32 = root.addList("32");
        group32.addItem("0", "320", "WEIGHT_NET_LB", "^320([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("1", "321", "LENGTH_IN", "^321([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("2", "322", "LENGTH_FT", "^322([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("3", "323", "LENGTH_YD", "^323([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("4", "324", "WIDTH_IN", "^324([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("5", "325", "WIDTH_FT", "^325([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("6", "326", "WIDTH_YD", "^326([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("7", "327", "HEIGHT_IN", "^327([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("8", "328", "HEIGHT_FT", "^328([0-5])(\\d{6})$", 6, false, true);
        group32.addItem("9", "329", "HEIGHT_YD", "^329([0-5])(\\d{6})$", 6, false, true);

        Field_List group33 = root.addList("33");
        group33.addItem("0", "330", "WEIGHT_GROSS_KG", "^330([0-5])(\\d{6})$", 6, false, true);
        group33.addItem("1", "331", "LENGTH_LOG_M", "^331([0-5])(\\d{6})$", 6, false, true);
        group33.addItem("2", "332", "WIDTH_LOG_M", "^332([0-5])(\\d{6})$", 6, false, true);
        group33.addItem("3", "333", "HEIGHT_LOG_M", "^333([0-5])(\\d{6})$", 6, false, true);
        group33.addItem("4", "334", "AREA_LOG_M", "^334([0-5])(\\d{6})$", 6, false, true);
        group33.addItem("5", "335", "VOLUME_LOG_L", "^335([0-5])(\\d{6})$", 6, false, true);
        group33.addItem("6", "336", "VOLUME_LOG_M3", "^336([0-5])(\\d{6})$", 6, false, true);
        group33.addItem("7", "337", "KG_PER_M2", "^337([0-5])(\\d{6})$", 6, false, true);

        Field_List group34 = root.addList("34");
        group34.addItem("0", "340", "WEIGHT_GROSS_LB", "^340([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("1", "341", "LENGTH_LOG_IN", "^341([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("2", "342", "LENGTH_LOG_FT", "^342([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("3", "343", "LENGTH_LOG_YD", "^343([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("4", "344", "WIDTH_LOG_IN", "^344([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("5", "345", "WIDTH_LOG_FT", "^345([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("6", "346", "WIDTH_LOG_YD", "^346([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("7", "347", "HEIGHT_LOG_IN", "^347([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("8", "348", "HEIGHT_LOG_FT", "^348([0-5])(\\d{6})$", 6, false, true);
        group34.addItem("9", "349", "HEIGHT_LOG_YD", "^349([0-5])(\\d{6})$", 6, false, true);

        Field_List group35 = root.addList("35");
        group35.addItem("0", "350", "AREA_IN", "^350([0-5])(\\d{6})$", 6, false, true);
        group35.addItem("1", "351", "AREA_FT", "^351([0-5])(\\d{6})$", 6, false, true);
        group35.addItem("2", "352", "AREA_YD", "^352([0-5])(\\d{6})$", 6, false, true);
        group35.addItem("3", "353", "AREA_LOG_IN", "^353([0-5])(\\d{6})$", 6, false, true);
        group35.addItem("4", "354", "AREA_LOG_FT", "^354([0-5])(\\d{6})$", 6, false, true);
        group35.addItem("5", "355", "AREA_LOG_YD", "^355([0-5])(\\d{6})$", 6, false, true);
        group35.addItem("6", "356", "WEIGHT_NET_T", "^356([0-5])(\\d{6})$", 6, false, true);
        group35.addItem("7", "357", "VOLUME_NET_OZ", "^357([0-5])(\\d{6})$", 6, false, true);

        Field_List group36 = root.addList("36");
        group36.addItem("0", "360", "VOLUME_NET_QT", "^360([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("1", "361", "VOLUME_NET_GAL", "^361([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("2", "362", "VOLUME_LOG_QT", "^362([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("3", "363", "VOLUME_LOG_GAL", "^363([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("4", "364", "VOLUME_IN3", "^364([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("5", "365", "VOLUME_FT3", "^365([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("6", "366", "VOLUME_YD3", "^366([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("7", "367", "VOLUME_LOG_IN3", "^367([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("8", "368", "VOLUME_LOG_FT3", "^368([0-5])(\\d{6})$", 6, false, true);
        group36.addItem("9", "369", "VOLUME_LOG_YD3", "^369([0-5])(\\d{6})$", 6, false, true);

        root.addItem("37", "37", "COUNT", "^37(\\d{0,8})$", 0, true, false);
        Field_List group39 = root.addList("39");
        group39.addItem("0", "390", "AMOUNT_LOCAL", "^390([0-9])(\\d{0,15})$", 0, true, true);
        group39.addItem("1", "391", "AMOUNT_ISO4217", "^391([0-9])(\\d{3})(\\d{0,15})$", 0, true, true);
        group39.addItem("2", "392", "PRICE_LOCAL", "^392([0-9])(\\d{0,15})$", 0, true, true);
        group39.addItem("3", "393", "PRICE_ISO421", "^393([0-9])(\\d{3})(\\d{0,15})$", 0, true, true);
        group39.addItem("4", "394", "PRCNT_OFF", "^394([0-3])(\\d{4})$", 4, false, true);
        ...
        group41.addItem("1", "411", "BILL_TO", "^411(\\d{13})$", 13, false, false);
        group41.addItem("2", "412", "PURCHASE_FROM", "^412(\\d{13})$", 13, false, false);
        group41.addItem("3", "413", "SHIP_FOR_LOC", "^413(\\d{13})$", 13, false, false);
        group41.addItem("4", "414", "LOC_NO", "^414(\\d{13})$", 13, false, false);
        group41.addItem("5", "415", "PAY_TO", "^415(\\d{13})$", 13, false, false);
        group41.addItem("6", "416", "PROD_SERV_LOC", "^416(\\d{13})$", 13, false, false);
        ...
        group432.addItem("4", "4324", "NBEF_DEL_DT", "^4324(\\d{10})$", 10, false, false);
        group432.addItem("5", "4325", "NAFT_DEL_DT", "^4325(\\d{10})$", 10, false, false);
        group432.addItem("6", "4326", "REL_DATE", "^4326(\\d{6})$", 3, false, false);
